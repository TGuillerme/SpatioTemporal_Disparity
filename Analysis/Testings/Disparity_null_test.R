...
null_trees_yule<-null.data(tree="yule", matrix=Nexus_data$matrix, replicates=10, verbose=TRUE)
null_trees_bd<-null.data(tree="bd", matrix=Nexus_data$matrix, replicates=10, verbose=TRUE)
null_mattre_randyule<-null.data(tree="yule", matrix=states_list, matrix.model="random", replicates=10, verbose=TRUE, n.tips=Ntip(tree))
null_mattre_randbd<-null.data(tree="bd", matrix=states_list, matrix.model="random", replicates=10, verbose=TRUE, n.tips=Ntip(tree))
null_mattre_simcyule<-null.data(tree="yule", matrix=states_list, matrix.model="sim.char", replicates=10, verbose=TRUE, n.tips=Ntip(tree))
null_mattre_simcbd<-null.data(tree="bd", matrix=states_list, matrix.model="sim.char", replicates=10, verbose=TRUE, n.tips=Ntip(tree))
...
ace_null_matrices_random<-anc.state(tree, null_matrices_random, method='ML-ape', verbose=TRUE)
save(ace_null_matrices_random, file=paste("../Data/",chain_name,"_ace_null_matrices_random.Rda", sep=""))
