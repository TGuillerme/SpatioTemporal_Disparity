...
distance_inte<-"_distance-@@@.Rda"
distance_intn<-"_distance-@@@.Rda"
...
#Distances
slat_dist_nod<-load(paste(data_path, chain_name[1], "/", chain_name[1], distance_node, sep=""))
beck_dist_nod<-load(paste(data_path, chain_name[2], "/", chain_name[2], distance_node, sep=""))
slat_dist_int<-load(paste(data_path, chain_name[1], "/", chain_name[1], distance_inte, sep=""))
beck_dist_int<-load(paste(data_path, chain_name[2], "/", chain_name[2], distance_inte, sep=""))
slat_dist_ino<-load(paste(data_path, chain_name[1], "/", chain_name[1], distance_intn, sep=""))
beck_dist_ino<-load(paste(data_path, chain_name[2], "/", chain_name[2], distance_intn, sep=""))
...
#Distance
distance_nodes_slater<-get(slat_dist_nod)[[3]]
distance_nodes_beck  <-get(beck_dist_nod)[[3]]
distance_inter_slater<-get(slat_dist_int)[[3]]
distance_inter_beck  <-get(beck_dist_int)[[3]]
distance_intno_slater<-get(slat_dist_ino)[[3]]
distance_intno_beck  <-get(beck_dist_ino)[[3]]
...
#Intervals
pco_int_slater_int<-slice.pco(pco_inter_slater, tree_slater, intervals,  include.nodes=FALSE, FAD_LAD=FADLADslat, verbose=TRUE)
pco_int_beck_int  <-slice.pco(pco_inter_beck  , tree_beck  , intervals,  include.nodes=FALSE, FAD_LAD=FADLADbeck, verbose=TRUE)
pco_int_slater_ino<-slice.pco(pco_intno_slater, tree_slater, intervals,  include.nodes=TRUE , FAD_LAD=FADLADslat, verbose=TRUE)
pco_int_beck_ino  <-slice.pco(pco_intno_beck  , tree_beck  , intervals,  include.nodes=TRUE , FAD_LAD=FADLADbeck, verbose=TRUE)
...
#acc
pco_slice_slater_acc<-slice.pco(pco_slater, tree_slater, slices, method='acctran', FAD_LAD=FADLADslat, verbose=TRUE)
pco_slice_beck_acc  <-slice.pco(pco_beck  , tree_beck  , slices, method='acctran', FAD_LAD=FADLADbeck, verbose=TRUE)
#del
pco_slice_slater_del<-slice.pco(pco_slater, tree_slater, slices, method='deltran', FAD_LAD=FADLADslat, verbose=TRUE)
pco_slice_beck_del  <-slice.pco(pco_beck  , tree_beck  , slices, method='deltran', FAD_LAD=FADLADbeck, verbose=TRUE)
#pro
...
#################
#slater
reftest_centroid_int_slater<-disparity.test(pco_int_slater_int[22:35], method="centroid", test="reference", bootstraps=1000)
reftest_centroid_ino_slater<-disparity.test(pco_int_slater_ino[22:35], method="centroid", test="reference", bootstraps=1000)
...
#Saving
reftests_centroid_slater<-list("intervals"=reftest_centroid_int_slater, "int+nodes"=reftest_centroid_ino_slater, "punctuate"=reftest_centroid_ran_slater, "acctran"=reftest_centroid_acc_slater, "deltran"=reftest_centroid_del_slater, "gradual"=reftest_centroid_pro_beck)
save(reftests_centroid_slater, file="reftests_centroid_slater.Rda")

#beck
reftest_centroid_int_beck<-disparity.test(pco_int_beck_int[22:35], method="centroid", test="reference", bootstraps=1000)
reftest_centroid_ino_beck<-disparity.test(pco_int_beck_ino[22:35], method="centroid", test="reference", bootstraps=1000)
...
#################
#slater
reftest_sum.range_int_slater<-disparity.test(pco_int_slater_int[22:35], method="sum.range", test="reference", bootstraps=1000)
reftest_sum.range_ino_slater<-disparity.test(pco_int_slater_ino[22:35], method="sum.range", test="reference", bootstraps=1000)
...
#Saving
reftests_sum.range_slater<-list("intervals"=reftest_sum.range_int_slater, "int+nodes"=reftest_sum.range_ino_slater, "punctuate"=reftest_sum.range_ran_slater, "acctran"=reftest_sum.range_acc_slater, "deltran"=reftest_sum.range_del_slater, "gradual"=reftest_sum.range_pro_beck)
save(reftests_sum.range_slater, file="reftests_sum.range_slater.Rda")

#beck
reftest_sum.range_int_beck<-disparity.test(pco_int_beck_int[22:35], method="sum.range", test="reference", bootstraps=1000)
reftest_sum.range_ino_beck<-disparity.test(pco_int_beck_ino[22:35], method="sum.range", test="reference", bootstraps=1000)
...
#################
#slater
reftest_product.range_int_slater<-disparity.test(pco_int_slater_int[22:35], method="product.range", test="reference", bootstraps=1000)
reftest_product.range_ino_slater<-disparity.test(pco_int_slater_ino[22:35], method="product.range", test="reference", bootstraps=1000)
...
#Saving
reftests_product.range_slater<-list("intervals"=reftest_product.range_int_slater, "int+nodes"=reftest_product.range_ino_slater, "punctuate"=reftest_product.range_ran_slater, "acctran"=reftest_product.range_acc_slater, "deltran"=reftest_product.range_del_slater, "gradual"=reftest_product.range_pro_beck)
save(reftests_product.range_slater, file="reftests_product.range_slater.Rda")

#beck
reftest_product.range_int_beck<-disparity.test(pco_int_beck_int[22:35], method="product.range", test="reference", bootstraps=1000)
reftest_product.range_ino_beck<-disparity.test(pco_int_beck_ino[22:35], method="product.range", test="reference", bootstraps=1000)
...
#################
#slater
reftest_sum.variance_int_slater<-disparity.test(pco_int_slater_int[22:35], method="sum.variance", test="reference", bootstraps=1000)
reftest_sum.variance_ino_slater<-disparity.test(pco_int_slater_ino[22:35], method="sum.variance", test="reference", bootstraps=1000)
...
#Saving
reftests_sum.variance_slater<-list("intervals"=reftest_sum.variance_int_slater, "int+nodes"=reftest_sum.variance_ino_slater, "punctuate"=reftest_sum.variance_ran_slater, "acctran"=reftest_sum.variance_acc_slater, "deltran"=reftest_sum.variance_del_slater, "gradual"=reftest_sum.variance_pro_beck)
save(reftests_sum.variance_slater, file="reftests_sum.variance_slater.Rda")

#beck
reftest_sum.variance_int_beck<-disparity.test(pco_int_beck_int[22:35], method="sum.variance", test="reference", bootstraps=1000)
reftest_sum.variance_ino_beck<-disparity.test(pco_int_beck_ino[22:35], method="sum.variance", test="reference", bootstraps=1000)
...
#################
#slater
reftest_product.variance_int_slater<-disparity.test(pco_int_slater_int[22:35], method="product.variance", test="reference", bootstraps=1000)
reftest_product.variance_ino_slater<-disparity.test(pco_int_slater_ino[22:35], method="product.variance", test="reference", bootstraps=1000)
...
#Saving
reftests_product.variance_slater<-list("intervals"=reftest_product.variance_int_slater, "int+nodes"=reftest_product.variance_ino_slater, "punctuate"=reftest_product.variance_ran_slater, "acctran"=reftest_product.variance_acc_slater, "deltran"=reftest_product.variance_del_slater, "gradual"=reftest_product.variance_pro_beck)
save(reftests_product.variance_slater, file="reftests_product.variance_slater.Rda")

#beck
reftest_product.variance_int_beck<-disparity.test(pco_int_beck_int[22:35], method="product.variance", test="reference", bootstraps=1000)
reftest_product.variance_ino_beck<-disparity.test(pco_int_beck_ino[22:35], method="product.variance", test="reference", bootstraps=1000)
...
#Saving
reftests_centroid_slater<-list("intervals"=seqtest_centroid_int_slater, "int+nodes"=seqtest_centroid_ino_slater, "punctuate"=seqtest_centroid_ran_slater, "acctran"=seqtest_centroid_acc_slater, "deltran"=seqtest_centroid_del_slater, "gradual"=seqtest_centroid_pro_beck)
save(reftests_centroid_slater, file="reftests_centroid_slater.Rda")
...
#Saving
reftests_sum.range_slater<-list("intervals"=seqtest_sum.range_int_slater, "int+nodes"=seqtest_sum.range_ino_slater, "punctuate"=seqtest_sum.range_ran_slater, "acctran"=seqtest_sum.range_acc_slater, "deltran"=seqtest_sum.range_del_slater, "gradual"=seqtest_sum.range_pro_beck)
save(reftests_sum.range_slater, file="reftests_sum.range_slater.Rda")
...
#Saving
reftests_product.range_slater<-list("intervals"=seqtest_product.range_int_slater, "int+nodes"=seqtest_product.range_ino_slater, "punctuate"=seqtest_product.range_ran_slater, "acctran"=seqtest_product.range_acc_slater, "deltran"=seqtest_product.range_del_slater, "gradual"=seqtest_product.range_pro_beck)
save(reftests_product.range_slater, file="reftests_product.range_slater.Rda")
...
#Saving
reftests_sum.variance_slater<-list("intervals"=seqtest_sum.variance_int_slater, "int+nodes"=seqtest_sum.variance_ino_slater, "punctuate"=seqtest_sum.variance_ran_slater, "acctran"=seqtest_sum.variance_acc_slater, "deltran"=seqtest_sum.variance_del_slater, "gradual"=seqtest_sum.variance_pro_beck)
save(reftests_sum.variance_slater, file="reftests_sum.variance_slater.Rda")
