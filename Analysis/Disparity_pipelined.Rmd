...
Rather than using classic time binning (that suffers from couple of caveats described in the manuscript), we here introduce a time slicing method that takes ``snapshots'' of disparity every 5 Mya.
It also allows to propose *a priori* the evolutionary model (here we use gradual evolution).
