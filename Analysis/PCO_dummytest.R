...
clade.1<-as.matrix(pco.scores[match(clade1, row.names(pco.scores)),1:2])
clade.2<-as.matrix(pco.scores[match(clade2, row.names(pco.scores)),1:2])

plot.pco(pco.scores, clade.1, clade.2)
