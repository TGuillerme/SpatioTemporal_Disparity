...
plot.disparity(extract.disp(disp_sli_nodes95_ran[[1]], rarefaction="max"), diversity=slices_nodes95_div, main="Punctuated", xlab="Time (Ma)", y2lab="", ylab="Median distance from centroid")
abline(v=47, col="red")
plot.disparity(extract.disp(disp_sli_nodes95_pro[[1]], rarefaction="max"), diversity=slices_nodes95_div, main="Gradual", xlab="Time (Ma)", y2lab="Number of tips and nodes", ylab="")
abline(v=47, col="red")
plot.disparity(extract.disp(disp_sli_nodes95_ran[[1]], rarefaction=8), diversity=rar_diversity, main="Punctuated - 8 taxa", xlab="Time (Ma)", y2lab="", ylab="Median distance from centroid")
abline(v=47, col="red")
plot.disparity(extract.disp(disp_sli_nodes95_pro[[1]], rarefaction=8), diversity=rar_diversity, main="Gradual - 8 taxa", xlab="Time (Ma)", y2lab="Number of tips and nodes", ylab="")
abline(v=47, col="red")
plot.disparity(extract.disp(disp_sli_nodes95_ran[[1]], rarefaction="min"), diversity=rep(3,60), main="Punctuated - 3 taxa", xlab="Time (Ma)", y2lab="", ylab="Median distance from centroid")
abline(v=47, col="red")
plot.disparity(extract.disp(disp_sli_nodes95_pro[[1]], rarefaction="min"), diversity=rep(3,60), main="Gradual - 3 taxa", xlab="Time (Ma)", y2lab="Number of tips and nodes", ylab="")
abline(v=47, col="red")
par(op)
