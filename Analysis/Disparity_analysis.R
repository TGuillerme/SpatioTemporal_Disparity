...
plot.disparity(dis_ran_max_beck, diversity=dis_ran_max_beck$rarefaction, main="Eutherian (punctuated)", xlab="Time (Mya)", y2lab="", ylab="Distance from centroid")
abline(v=22, col="red")
plot.disparity(dis_ran_max_slater, diversity=dis_ran_max_slater$rarefaction, main="Mammaliformes (punctuated)", xlab="Time (Mya)", y2lab="Species richness", ylab="")
abline(v=22, col="red")
plot.disparity(dis_pro_max_beck, diversity=dis_pro_max_beck$rarefaction, main="Eutherian (gradual)", xlab="Time (Mya)", y2lab="", ylab="Distance from centroid")
abline(v=22, col="red")
plot.disparity(dis_pro_max_slater, diversity=dis_pro_max_slater$rarefaction, main="Mammaliformes (gradual)", xlab="Time (Mya)", y2lab="Species richness", ylab="")
abline(v=22, col="red")
par(op)
