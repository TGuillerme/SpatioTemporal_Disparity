...
\section*{Abstract}
Textbook accounts state that after the extinction of non-avian dinosaurs at the Cretaceous-Paleogene (K-Pg) boundary 66 million years ago, mammals rapidly diversified to fill their empty ecological niches.
...
% NC: We is first person!
% NC: This was *way* too jargon heavy. It's meant to be written for members of the public as well as scientists. I have tried to simplify. Take note for press releases. For example - disparity is not a well known thing.
\section*{Author Summary}
Many people are familiar with the idea that the extinction of dinosaurs at the Cretaceous-Paleogene (K-Pg) boundary, 66 million years ago, allowed mammals to become the dominant vertebrate group on Earth.
However, recent studies show mixed evidence for this idea.
The different results are related to the kind of data used (fossils or living species) and how the analyses were conducted.
Here we use both living and fossil species simultaneously, and investigate whether changes in the diversity of body shapes/forms exhibited by mammals are directly related to the K-Pg mass extinction.
We find no direct effect of the mass extinction on the diversity of mammals. 
We therefore suggest that, contrary to popular belief, the extinction of many terrestrial vertebrates, including the dinosaurs, at the K-Pg boundary did not significantly affect the evolution of mammals.
...
\bibitem{Benton85}
Benton MJ.
\newblock Mass extinction among non-marine tetrapods.
\newblock Nature. 1985 08;316(6031):811--814.
\newblock Available from: \url{http://dx.doi.org/10.1038/316811a0}.
...
\bibitem{Ciampaglio2004}
Ciampaglio CN.
\newblock Measuring changes in articulate brachiopod morphology before and
  after the {P}ermian mass extinction event: do developmental constraints limit
  morphological innovation?
\newblock Evolution \& Development. 2004;6(4):260--274.
\newblock Available from:
...
\bibitem{Payne22052014}
Payne JL, Heim NA, Knope ML, McClain CR.
\newblock Metabolic dominance of bivalves predates brachiopod diversity decline
  by more than 150 million years.
\newblock Proceedings of the Royal Society B: Biological Sciences.
  2014;281(1783).
\newblock Available from:
...
\bibitem{Douady2003285}
Douady CJ, Douzery EJP.
\newblock Molecular estimation of eulipotyphlan divergence times and the
  evolution of “{I}nsectivora”.
\newblock Molecular Phylogenetics and Evolution. 2003;28(2):285--296.
\newblock Available from:
  \url{http://www.sciencedirect.com/science/article/pii/S1055790303001192}.

\bibitem{bininda-emondsthe2007}
...
\newblock Available from: \url{http://dx.doi.org/10.1038/nature05634}.
...
\bibitem{Wood01032013}
Wood HM, Matzke NJ, Gillespie RG, Griswold CE.
\newblock Treating Fossils as Terminal Taxa in Divergence Time Estimation
  Reveals Ancient Vicariance Patterns in the {P}alpimanoid Spiders.
\newblock Systematic Biology. 2013;62(2):264--284.
\newblock Available from:
  \url{http://sysbio.oxfordjournals.org/content/62/2/264.abstract}.

\bibitem{Arcila2015131}
Arcila D, Pyron RA, Tyler JC, Ortí G, Betancur-R R.
\newblock An evaluation of fossil tip-dating versus node-age calibrations in
  tetraodontiform fishes ({T}eleostei: {P}ercomorphaceae).
\newblock Molecular Phylogenetics and Evolution. 2015;82, Part A(0):131--145.
\newblock Available from:
...
\bibitem{Wesley-Hunt2005}
Wesley-Hunt GD.
\newblock The morphological diversification of carnivores in {N}orth {A}merica.
\newblock Paleobiology. 2005 2014/08/25;31(1):35--55.
\newblock Available from:
  \url{http://www.psjournals.org/doi/abs/10.1666/0094-8373%282005%29031%3C0035%3ATMDOCI%3E2.0.CO%3B2}.

\bibitem{Pearman2008149}
Pearman PB, Guisan A, Broennimann O, Randin CF.
\newblock Niche dynamics in space and time.
\newblock Trends in Ecology and Evolution. 2008;23(3):149--158.
\newblock Available from:
  \url{http://www.sciencedirect.com/science/article/pii/S0169534708000372}.

\bibitem{OlsonRadiation}
Olson ME, Arroyo-Santos A.
\newblock Thinking in continua: beyond the “adaptive radiation” metaphor.
\newblock BioEssays. 2009;31(12):1337--1346.
\newblock Available from: \url{http://dx.doi.org/10.1002/bies.200900102}.
...
\bibitem{Erwin2007}
Erwin DH.
\newblock Disparity: Morphological Pattern And Developmental Context.
\newblock Palaeontology. 2007;50(1):57--73.
\newblock Available from:
  \url{http://dx.doi.org/10.1111/j.1475-4983.2006.00614.x}.

\bibitem{Hughes20082013}
Hughes M, Gerber S, Wills MA.
\newblock Clades reach highest morphological disparity early in their
  evolution.
\newblock Proceedings of the National Academy of Sciences.
  2013;110(34):13875--13879.
\newblock Available from:
...
\bibitem{cisneros2010}
Cisneros JC, Ruta M.
\newblock Morphological diversity and biogeography of procolophonids
  ({A}mniota: {P}arareptilia).
\newblock Journal of Systematic Palaeontology. 2010;8(4):607--625.
\newblock Available from:
  \url{http://www.tandfonline.com/doi/abs/10.1080/14772019.2010.491986}.

\bibitem{prentice2011}
Prentice KC, Ruta P, Benton MJ.
\newblock Evolution of morphological disparity in pterosaurs.
\newblock Journal of Systematic Palaeontology. 2011;9(3):337--353.
\newblock Available from:
  \url{http://www.tandfonline.com/doi/abs/10.1080/14772019.2011.565081}.

\bibitem{brusattedinosaur2012}
Brusatte S, Butler RJ, Prieto-M{\'a}rquez A, Norell MA.
\newblock Dinosaur morphological diversity and the {end-{C}retaceous}
  extinction.
\newblock Nature Communications. 2012;3:804--804.
\newblock Available from: \url{http://dx.doi.org/10.1038/ncomms1815}.

\bibitem{bentonmodels2014}
Benton MJ, Forth J, Langer MC.
\newblock Models for the rise of the dinosaurs.
\newblock Current biology : {CB}. 2014;24(2):R87--R95.
\newblock Available from: \url{http://dx.doi.org/10.1016/j.cub.2013.11.063}.
...
\bibitem{Hunt20112007}
Hunt G.
\newblock The relative importance of directional change, random walks, and
  stasis in the evolution of fossil lineages.
\newblock Proceedings of the National Academy of Sciences.
  2007;104(47):18404--18408.
\newblock Available from:
...
\bibitem{Foote29111996}
Foote M.
\newblock Ecological Controls on the Evolutionary Recovery of Post-{P}aleozoic
  {C}rinoids.
\newblock Science. 1996;274(5292):1492--1495.
\newblock Available from:
...
\bibitem{huang2015origins}
Huang S, Roy K, Jablonski D.
\newblock Origins, bottlenecks, and present-day diversity: Patterns of
  morphospace occupation in marine bivalves.
\newblock Evolution. 2015;Available from:
