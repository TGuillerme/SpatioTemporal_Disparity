...
All used data are available on Figshare (\url{http://dx.doi.org/10.6084/m9.figshare.1539545}).
...
%TG: maybe we want to step back here and use the cites proposed by Steve Brusatte.
...
Note that we also calculated the sum and products of ranges and variances and refer to these results in the supplementary material (Figure S6 to S9). % link to supp.
