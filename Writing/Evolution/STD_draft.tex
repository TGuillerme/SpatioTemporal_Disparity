...
Here we propose a new methodological approach to this debate by looking at living and fossil taxa simultaneously.
...
Using a novel, continuous time-slicing method for measuring changes in disparity-through-time that allows to specify models of evolution, we found no significant change in disparity before and after the K-Pg boundary, under either a gradual or punctuated model of evolution.
This suggests that the extinctions at the end of the Cretaceous did not affect mammalian morphological evolution. 
...
Thanks to Graeme Lloyd, Andrew Jackson, Gavin Thomas, Graham Slater, Steve Brusatte, Sive Finlay and two anonymous reviewer for helpful comments on a previous version of the manuscript. 
