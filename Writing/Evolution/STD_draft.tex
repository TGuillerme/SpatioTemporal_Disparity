...
This suggests that the extinctions at the end of the Cretaceous did not affect the evolution of mammalian morphological diversity. 
...
Instead here we use morphological diversity, also known as disparity \citep[e.g.][]{Wills1994,Erwin2007,Hughes20082013}, rather than species richness as our measure of diversity. %, as a way to quantify changes in mammalian morphology.% that should relate to the ecology of the species (although morphology does not always correlate with ecology \citep[e.g.][]{anderson2012using}).
%TG: I've added:
...
Additionally, both datasets contain few living mammals (respectively 22 and 14 for the Mammaliaformes and Eutheria datasets) due to the surprising rarity of available cladistic data for these taxa \citep{MissingMammals}. % NC: Why is it worth noting exactly? TG: changed to additionally
