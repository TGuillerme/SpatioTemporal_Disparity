...
\noindent{\Large \bf DISCLAIMER: THIS DRAFT IS NOT FULLY COMPLETED AND HAS NOT BEEN PROOF READ.} % This is just because I link to the draft on my website.
...
\begin{enumerate}
    ...
    \begin{enumerate}[(i)]
        ...
        But note that not all studies use biostratigraphy and sometimes arbitrarily time bins of equal duration are used which also fix this caveat \citep{hopkinsdecoupling2013,bensonfaunal2014}.
