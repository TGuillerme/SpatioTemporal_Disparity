...
Our results differ from previous studies that found an increase increase in disparity in the Early Paleocene \cite{Wilson2013}. %TG: actually I dropped Grossnickle, they don't test K-Pg effect and just detect increase during Cretaceous, we don't care about that.
