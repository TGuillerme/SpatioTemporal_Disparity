...
Therefore, we did not find any significant evidence that the extinction of the dominant terrestrial vertebrates at the K-Pg boundary affected Cenozoic mammals evolution.
...
Secondly, the core of the debate in mammalian evolution is weather placental mammals originated before or after the K-Pg boundary \citep{dosReis2012,O'Leary08022013,Springer09082013,O’Leary09082013,dosReis2014}.
The traditional definition of the infraclass Placentalia is ``the least inclusive clade that includes all extant placentals'' \citep{beckancient2014}.
However, part of the dating debate might be due to the lack of clear characters that can be used to define early placental mammals \citep{bininda2012rocking,beckancient2014}.
