...
Despite recent studies revealing unexpected mammalian diversification during the Jurassic \citep{Close2015,Lee2015R759}, until now, this question was only assessed on data restrained to the northern-American Therian mammals (excluding Monotremata) and without formally testing the effect of the K-Pg event \citep{Wilson2013}.
...
To test this, we performed t-tests among the time subsamples before and after the K-Pg boundary 66 Ma, i.e. the subsamples at 70 and 65 Ma \citep[e.g. as used in][]{anderson2012using,zelditch2012geometric,smith2014joined}, for both Mammaliaformes and Eutheria datasets and using both the gradual and punctuated evolutionary models.
...
Changes in the number of tips and nodes, however, have a more idiosyncratic pattern with a steady increase up until the Middle Jurassic (Aalenian-Bajocian boundary; 170 Ma; Fig @@@ supplementary) and then fluctuations during the rest of the Mesozoic and the Cenozoic (Fig \ref{fig:Fig_Raw_results}).
