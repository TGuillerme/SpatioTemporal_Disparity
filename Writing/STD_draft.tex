...
Mass extinctions result in short-term, catastrophic, species richness declines. 
For example, during the end Permian extinction, 95\% of marine genera went extinct \cite{RaupPT,BentonPT} and % NC add another brief example or two. 
. 
...
These shifts in ecological dominance are characterized by the decline of one clade that is replaced by a different unrelated clade with a similar niche \cite{Brusatte12092008} (e.g. Brachiopoda and Bivalvia at the end Permian extinction \cite{Sepkiski1981,CLAPHAM01102006} but see \cite{Payne22052014}). 
One classical example of such a shift is the replacement of non-avian dinosaurs by placental mammals after the Cretaceous-Palaeogene (K-Pg) mass extinction, 66 Million years ago (Mya) \cite{rennetime2013}, that led to the ``rise of the age of the mammals" \cite{archibald2011extinction,Lovergrove}.

% 2§ explaining the rise of the age of the mammals view.
This view proposes that placental mammals radiated during the Palaeogene because the K-Pg extinction led to an ``ecological release from the vice grip which the dinosaurs held over Mesozoic mammals" \cite{Lovergrove}. % TG: this might be an aggressive use of the quote (I don't know if you plan to ever work with Lovergrove) but I think it could ring positively to few non-old-school people.
This interpretation can be linked to a thorough analysis of the fossil record (e.g. \cite{goswamia2011,O'Leary08022013}) underlining the absence of placental mammals fossils before the K-Pg event \cite{archibald2011extinction,goswamia2011,Slater2012MEE,O'Leary08022013,Wilson2013,Brusatte2015}. This hypothesis proposes that even if placental mammals originated during the late Cretaceous they only started diversifying during the Palaeogene \cite{O'Leary08022013,Springer09082013,O’Leary09082013}. One proposed evolutionary process is that the extinction of many terrestrial vertebrates at the K-Pg boundary (including the dominant non-avian dinosaur group \cite{archibald2011extinction,O'Leary08022013,Brusatte2015}) led to ecological niche vacancy \cite{Pearman2008149,slaterCetacean,hopkinsdecoupling2013}. This allowed the placental mammals to undergo an adaptive radiation into these vacant niches during the Palaeogene until they rapidly reached ecological dominance \cite{archibald2011extinction,O'Leary08022013,Lovergrove}. This can be opposed to shifts in ecological dominance due to direct competition (e.g. \cite{Brusatte12092008}).

% §3 However, this is contrasted with molecular data. Also this is hard to explain due to timing/concept difficulties
However, one opposite hypothesis based in molecular approaches, proposes that both the origin and the diversification of placental mammals started prior to the K-Pg extinction event without being drastically affected by it \cite{Douady2003285,bininda2007delayed,meredithimpacts2011,Stadler12042011,beckancient2014}. The timing of the events around the K-Pg boundary is a crucial element for investigating the effect of the extinction event on mammals. Previous work has led to a consensus concerning the timing of the events around the K-Pg boundary, (asteroid impact at 66 Mya \cite{rennetime2013}) as well as the causes (e.g. \cite{rennetime2013,Brusatte2015}) and the effect on species extinction (e.g. \cite{Erwin1998344,Brusatte2015}) as well as species diversification (e.g. \cite{Stadler12042011,meredithimpacts2011,O'Leary08022013}). Therefore, the two hypothesis probably differs on the focal data (palaeontological or neontological) and the methods used (e.g. \cite{meredithimpacts2011} \textit{vs.} \cite{O'Leary08022013}). However, one major caveat in both approaches is the interpretation of the concept of adaptive radiation \cite{OlsonRadiation,Losos2010,glor2010phylogenetic} and niche vacancy \cite{Pearman2008149}. Most studies focus on taxonomic diversity as a proxy for niche occupancy \cite{Stadler12042011,meredithimpacts2011,O'Leary08022013} in order to validate/reject an adaptive radiation scenario \cite{archibald2011extinction,O'Leary08022013,Brusatte2015}. Therefore, to determine whether mammals underwent an adaptive radiation after the K-Pg boundary, two elements are crucial: (1) the data and (2) the proxy used to determine niche occupancy.
