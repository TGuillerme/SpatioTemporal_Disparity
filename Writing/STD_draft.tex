...
We predict that if the K-Pg extinction event had a significant effect on mammalian disparity, we should see a significant difference between the disparity at the end of the Cretaceous and at the start of the Paleogene.
...
In the Mammaliaformes dataset \citep{Slater2012MEE}, the minimum number of taxa in each subsample from 170 Ma to present was eight.
In the Eutheria dataset \citep{beckancient2014}, the minimum number of taxa in each subsample was three, however, from 150 Ma until the present, the minimum number of taxa is eight.
