...
\begin{enumerate}
    \item \texbf{Using all the axis of the cladisto-space}
    ...
    \item \texbf{Using the median centroid distance as disparity metric}
    ...
    \item \texbf{Using time slicing method}
    ...
    \end{enumerate}
    \item \texbf{Allowing to choose the evolutionary model}
