...
After constructing our distance matrices we transformed them using classic multidimensional scaling \citep[MDS;][]{torgerson1965multidimensional,GOWER01121966,cailliez1983analytical}.
...
Using this disparity metric, we measured disparity through time as the observed disparity in each subsections of the cladisto-space % NC: What's a subsection here?
at each point in time. % NC: It's not exactly each point in time is it? Perhaps need some vaguer phrase then refer people to the next section?
