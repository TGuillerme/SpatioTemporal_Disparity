...
We did, however, detect a small yet significant increase in disparity during the Eocene under punctuated evolutionary model.
Nonetheless, this effect is more likely to be linked to the PETM rather that a late lagged effect of the K-Pg boundary.
%FIND OUT WHAT'S HAPPENING
Can this be due to \textit{Lepidictis} (33.9 to 33.3 Ma) long branch? In gradual model, the subsample at 45 Ma always uses the tips ordinated data (\textit{Lepidictis}) but under the punctuated model, it picks up data data for either \textit{Lepidictis} or the node between \textit{Gypsonictops} (66.8 to 66 Ma) nodes being at $\sim$90 Ma (early Upper Cretaceous)
