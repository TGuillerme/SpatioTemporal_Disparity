...
Where $Edge_{n}$ is any phylogenetic edge value % NC: What's a phylogenetic edge value?
...
%\label{fig_slicing}
%\end{figure}
% NC: I don't think this figure helps as it is at present
...
For each sub-sample, we estimated its disparity assuming punctuated and gradual evolution.
