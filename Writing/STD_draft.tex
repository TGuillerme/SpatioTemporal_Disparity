...
This led to our removing 92/103 % NC : Wow your analyses aren't based on many taxa!
 taxa from \cite{Slater2012MEE} and 102 % NC: Pretty sure this isn't right or you'd have no data left
/102 from \cite{beckancient2014}.
...
NOTE: CHANGE n to k-2 because of the Cailliez correction (the two last vectors are null). See man(pcoa) for more details!
...
Instead, we use a more intuitive % NC: Still not sure if it's intuitive...
...
$k$ is the size of the distance matrix (i.e. the total number of taxa), $\mathbf{v}_{n}$ is any of the $n$ eigenvectors (i.e. the $n^{th}$ dimension of the cladisto-space),% $\mathbf{v}_{n_{i}}$ is the score for each taxa for $\mathbf{v}_{n}$ % TG: or is the part "Sum from i to k" in the equation sufficient to explain that?
 and $Centroid_{n}$ is  the centroid distance of the $n^{th}$ eigenvector (equation \ref{centroid}).
...
%Explain rarefaction better + Explain bootstrap (Ruxton)
...
%PERMANOVA: \citep{permanova}
%Anderson t-test: \citep{anderson2012using}
To assess if the K-Pg boundary had a significant effect on mammals disparity, we performed \cite{permanova}'s Permutational Analysis of Variance \citep[also referred to as PERMANOVA or NPANOVA; e.g.][]{brusatte50,ruta2013} to test the effect of time on disparity (disparity $\texttildelow$ time).
We calculated the euclidean distance of the ordinated data with 1000 permutations on both data sets and on both evolutionary scenario using the adonis function from the R package vegan \citep{vegan}.
When a significant effect of time on disparity was measured, we ran a series of post-hoc \textit{t-test} between the time slices \citep{anderson2012using,zelditch2012geometric,smith2014joined} to test whether there was a significant effect between:
\begin{enumerate}
...
For the tests involving multiple \textit{t-tests} (``sequential test'' and ``lag test'') we corrected the p-value using Holm-Bonferonni correction \citep{holm1979simple}. %dividing by the number p-values.
...
\begin{tabular}{rrrrr|rrrr}
  \hline
  & & gradual & & & & punctuated & & \\ 
 & difference & Df & T & p.value & difference & Df & T & p.value \\ 
  \hline
65:60 & 0.05 & 76.00 & 1.01 & 1.00 & 0.05 & 76.00 & 1.01 & 1.00 \\ 
  65:55 & 0.06 & 75.00 & 0.98 & 1.00 & 0.06 & 75.00 & 0.98 & 1.00 \\ 
  65:50 & 0.15 & 68.00 & 2.39 & 0.26 & 0.15 & 68.00 & 2.39 & 0.26 \\ 
  65:45 & 0.20 & 64.00 & 2.96 & 0.06 & 0.20 & 64.00 & 2.96 & 0.06 \\ 
  65:40 & 0.18 & 64.00 & 2.52 & 0.19 & 0.18 & 64.00 & 2.52 & 0.19 \\ 
  65:35 & 0.22 & 60.00 & 2.65 & 0.13 & 0.22 & 60.00 & 2.65 & 0.13 \\ 
  65:30 & 0.26 & 57.00 & 2.83 & 0.08 & 0.26 & 57.00 & 2.83 & 0.08 \\ 
  65:25 & 0.22 & 56.00 & 2.47 & 0.22 & 0.22 & 56.00 & 2.47 & 0.22 \\ 
  65:20 & 0.16 & 56.00 & 1.91 & 0.80 & 0.16 & 56.00 & 1.91 & 0.80 \\ 
  65:15 & 0.14 & 55.00 & 1.86 & 0.89 & 0.14 & 55.00 & 1.86 & 0.89 \\ 
  65:10 & 0.14 & 55.00 & 1.81 & 0.98 & 0.14 & 55.00 & 1.81 & 0.98 \\ 
  65:5 & 0.14 & 55.00 & 1.85 & 0.90 & 0.14 & 55.00 & 1.85 & 0.90 \\ 
  65:0 & 0.14 & 55.00 & 1.76 & 1.00 & 0.14 & 55.00 & 1.76 & 1.00 \\ 
   \hline
\end{tabular}
\end{table}
