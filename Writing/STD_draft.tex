...
\begin{landscape}
\begin{table}[H]
\caption{Disparity metrics from Wills et al 1994}
\centering
\begin{tabular}{p{4.5cm}p{2cm}p{1cm}p{10cm}p{6cm}}
  \hline
    Type of measurement & Type(II) & $N^o$ & Name & Calculation \\ %
  \hline
  Morphological variety & Volumes   & 1  & Total number of different character states       & \\
                        &           & 2  & Product of variances                             & \\
                        &           & 3  & Product of ranges                                & \\
