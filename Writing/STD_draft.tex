...
We used the cladistic morphological matrices and the Total Evidence tip dated trees \cite{ronquista2012} from \cite[][103 taxa and 446 morphological characters]{Slater2012MEE} and \cite[][102 taxa and 421 morphological characters]{beckancient2014}. Both studies respectively ranges from the 310 Million years ago (Mya - Late Carboniferous) and 170 Mya (Middle Jurassic) to the present and focuses on Mammaliamorpha up to the family level \cite{Slater2012MEE} and on Eutheria up to a genus level \cite{beckancient2014}. 
...
We used the first and last occurrences as the temporal span of each taxon in our analysis.% This data was collected from the original publications \cite{Slater2012MEE,beckancient2014}.
...
For both datasets %\cite{Slater2012MEE,beckancient2014}, % NC: Don't think you need to recite here, also maybe refer to them as two datasets (that each contain a matrix and a tree)
