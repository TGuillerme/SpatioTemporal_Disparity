...
\noindent
$k$ is the size of the distance matrix (i.e. the total number of taxa), $k_{n}$ is any $k$ value % NC: What do you mean by k value? 
of the $n^{th}$ eigenvector (i.e. the $n^{th}$ dimension of the cladisto-space) and $Centroid_{n}$ is the centroid distance of the $n^{th}$ eigenvector (equation \ref{centroid}).
% NC: This is confusing at present.
